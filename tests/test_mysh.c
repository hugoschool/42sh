...
Test(args_parser, check_input)
{
    ...
    cr_assert_eq(check_input(line1, strlen(line1)), 0, "Regular command should return 0");
    cr_assert_eq(check_input(line2, strlen(line2)), 0, "Help flag -h should be handled");
    cr_assert_eq(check_input(line3, strlen(line3)), 0, "Help flag --help should be handled");
    cr_assert_eq(check_input(line4, 0), 1, "Empty line should return 1");
}
